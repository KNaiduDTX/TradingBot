...
export declare class AnchorUtils {
     ...
     */
    static initWalletFromFile(filePath: string): Promise<readonly [import("@coral-xyz/anchor/dist/cjs/nodewallet").default, web3.Keypair]>;
    /**
     ...
     */
    static loadProgramFromConnection(connection: web3.Connection): Promise<Program<import("@coral-xyz/anchor").Idl>>;
    /**
