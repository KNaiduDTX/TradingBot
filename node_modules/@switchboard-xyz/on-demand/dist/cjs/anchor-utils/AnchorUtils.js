...
class AnchorUtils {
    static initWalletFromKeypair(keypair) {
        return __awaiter(this, void 0, void 0, function* () {
            const { default: NodeWallet } = yield Promise.resolve().then(() => __importStar(require("@coral-xyz/anchor/dist/cjs/nodewallet")));
    ...
    static initKeypairFromFile(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keypair = anchor_1.web3.Keypair.fromSecretKey(secretKey);
            return keypair;
        });
    }
    /**
     ...
     */
    static loadProgramFromConnection(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            const isDevnet = yield (0, utils_1.isDevnetConnection)(connection);
            const pid = isDevnet ? utils_1.ON_DEMAND_DEVNET_PID : utils_1.ON_DEMAND_MAINNET_PID;
            const wallet = yield this.initWalletFromKeypair(new anchor_1.web3.Keypair());
            const provider = new anchor_1.AnchorProvider(connection, wallet);
            return anchor_1.Program.at(pid, provider);
        });
    }
    /**
    ...
    static loadProgramFromEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pid = isDevnet ? utils_1.ON_DEMAND_DEVNET_PID : utils_1.ON_DEMAND_MAINNET_PID;
            return anchor_1.Program.at(pid, config.provider);
        });
    }
    /**
    ...
    static loadEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connection = new anchor_1.web3.Connection(data.json_rpc_url, {
                commitment,
            ...
            const program = yield anchor_1.Program.at(pid, provider);
            return {
    ...
    static loggedEvents(program, logs) {
        const coder = new anchor_1.BorshEventCoder(program.idl);
        const out = [];
        logs.forEach((log) => {
