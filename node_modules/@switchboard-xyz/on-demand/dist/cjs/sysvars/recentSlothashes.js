...
class RecentSlotHashes {
    ...
    static fetchLatest(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!accountInfo) {
                return [new anchor_1.BN(0), defaultHash];
            }
            ...
            return [new anchor_1.BN(slotNumber.toString()), encoded];
        });
    }
    static fetchLatestNSlothashes(connection, n) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!accountInfo) {
                return Array.from({ length: n }, () => [new anchor_1.BN(0), defaultHash]);
            }
            const out = [];
            const buffer = accountInfo.data;
            for (let i = 0; i < n; i++) {
                ...
                out.push([new anchor_1.BN(slotNumber.toString()), encoded]);
            }
            return out;
        });
    }
