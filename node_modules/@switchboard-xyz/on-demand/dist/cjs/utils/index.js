...
// Mainnet ID's
exports.ON_DEMAND_MAINNET_PID = new anchor_1.web3.PublicKey("SBondMDrcV3K4kxZR1HNVT7osZxAHVHgYXL5Ze1oMUv");
exports.ON_DEMAND_MAINNET_GUARDIAN_QUEUE = new anchor_1.web3.PublicKey("B7WgdyAgzK7yGoxfsBaNnY6d41bTybTzEh4ZuQosnvLK");
exports.ON_DEMAND_MAINNET_QUEUE = new anchor_1.web3.PublicKey("A43DyUGA7s8eXPxqEjJY6EBu1KKbNgfxF8h17VAHn13w");
exports.ON_DEMAND_MAINNET_QUEUE_PDA = anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("Queue"), exports.ON_DEMAND_MAINNET_QUEUE.toBuffer()], exports.ON_DEMAND_MAINNET_PID)[0];
// Devnet ID's
exports.ON_DEMAND_DEVNET_PID = new anchor_1.web3.PublicKey("Aio4gaXjXzJNVLtzwtNVmSqGKpANtXhybbkhtAC94ji2");
exports.ON_DEMAND_DEVNET_GUARDIAN_QUEUE = new anchor_1.web3.PublicKey("BeZ4tU4HNe2fGQGUzJmNS2UU2TcZdMUUgnCH6RPg4Dpi");
exports.ON_DEMAND_DEVNET_QUEUE = new anchor_1.web3.PublicKey("EYiAmGSdsQTuCw413V5BzaruWuCCSDgTPtBGvLkXHbe7");
exports.ON_DEMAND_DEVNET_QUEUE_PDA = anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("Queue"), exports.ON_DEMAND_DEVNET_QUEUE.toBuffer()], exports.ON_DEMAND_MAINNET_PID // SVM Devnet networks should be launched with SBond... as PID
)[0];
/**
...
function getProgramId(connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const isDevnet = yield isDevnetConnection(connection);
...
function getDefaultQueue() {
    return __awaiter(this, arguments, void 0, function* (solanaRPCUrl = "https://api.mainnet-beta.solana.com") {
        const connection = new anchor_1.web3.Connection(solanaRPCUrl, "confirmed");
...
function getQueue(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const queue = new anchor_1.web3.PublicKey(params.queueAddress);
        const program = "program" in params
            ? params.program
            : yield AnchorUtils_js_1.AnchorUtils.loadProgramFromConnection(new anchor_1.web3.Connection(params.solanaRPCUrl, "confirmed"));
...
function fetchAllLutKeys(queue, feeds) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Array.from(keyset).map((key) => new anchor_1.web3.PublicKey(key));
    });
}
/**
...
function getAssociatedTokenAddress(mint_1, owner_1) {
    return __awaiter(this, arguments, void 0, function* (mint, owner, allowOwnerOffCurve = false, programId = constants_js_1.SPL_TOKEN_PROGRAM_ID, associatedTokenProgramId = constants_js_1.SPL_ASSOCIATED_TOKEN_ACCOUNT_PROGRAM_ID) {
        if (!allowOwnerOffCurve && !anchor_1.web3.PublicKey.isOnCurve(owner.toBuffer())) {
            throw new Error("TokenOwnerOffCurveError");
        }
        const [address] = yield anchor_1.web3.PublicKey.findProgramAddress([owner.toBuffer(), programId.toBuffer(), mint.toBuffer()], associatedTokenProgramId);
        return address;
    });
}
function getAssociatedTokenAddressSync(mint, owner, allowOwnerOffCurve = false, programId = constants_js_1.SPL_TOKEN_PROGRAM_ID, associatedTokenProgramId = constants_js_1.SPL_ASSOCIATED_TOKEN_ACCOUNT_PROGRAM_ID) {
    ...
    const [address] = anchor_1.web3.PublicKey.findProgramAddressSync([owner.toBuffer(), programId.toBuffer(), mint.toBuffer()], associatedTokenProgramId);
    return address;
}
