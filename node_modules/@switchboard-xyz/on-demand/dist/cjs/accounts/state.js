...
class State {
    ...
    static keyFromSeed(program) {
        const [state] = anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("STATE")], program.programId);
        return state;
    }
    /**
    ...
    setConfigsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ix = yield this.program.instruction.stateSetConfigs({
                ...
                addCostWl: (_l = params.addCostWl) !== null && _l !== void 0 ? _l : anchor_1.web3.PublicKey.default,
                rmCostWl: (_m = params.rmCostWl) !== null && _m !== void 0 ? _m : anchor_1.web3.PublicKey.default,
            }, {
                accounts: {
                    state: this.pubkey,
