...
class Oracle {
    ...
    static create(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oracle = anchor_1.web3.Keypair.generate();
            const oracleStats = (yield anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("OracleStats"), oracle.publicKey.toBuffer()], program.programId))[0];
            const lutSigner = (yield anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("LutSigner"), oracle.publicKey.toBuffer()], program.programId))[0];
            const [delegationPool] = yield anchor_1.web3.PublicKey.findProgramAddressSync([
                buffer_1.Buffer.from("Delegation"),
                stateKey.toBuffer(),
            ...
            const [delegationGroup] = yield anchor_1.web3.PublicKey.findProgramAddressSync([
            ...
            const ix2 = yield program.instruction.oracleUpdateDelegation({
                ...
                accounts: {
                    ...
                    wsolVault: anchor_1.web3.PublicKey.findProgramAddressSync([
                        buffer_1.Buffer.from("RewardPool"),
                        delegationPool.toBuffer(),
                        constants_js_1.SOL_NATIVE_MINT.toBuffer(),
                    ], state.stakeProgram)[0],
                    switchVault: anchor_1.web3.PublicKey.findProgramAddressSync([
                        buffer_1.Buffer.from("RewardPool"),
                        delegationPool.toBuffer(),
    ...
    static createSVM(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [oracle] = yield anchor_1.web3.PublicKey.findProgramAddress([
                buffer_1.Buffer.from("Oracle"),
                params.queue.toBuffer(),
                params.sourceOracleKey.toBuffer(),
            ], program.programId);
            const oracleStats = (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("OracleStats"), oracle.toBuffer()], program.programId))[0];
            const lutSigner = (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("LutSigner"), oracle.toBuffer()], program.programId))[0];
            const [delegationPool] = yield anchor_1.web3.PublicKey.findProgramAddress([
                buffer_1.Buffer.from("Delegation"),
                stateKey.toBuffer(),
                oracleStats.toBuffer(),
                state.stakePool.toBuffer(),
            ...
            const [delegationGroup] = yield anchor_1.web3.PublicKey.findProgramAddress([
                buffer_1.Buffer.from("Group"),
                stateKey.toBuffer(),
                state.stakePool.toBuffer(),
                params.queue.toBuffer(),
    ...
    findSolanaOracleFromPDA() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isMainnet = oracleData.queue.equals(index_js_1.ON_DEMAND_MAINNET_QUEUE_PDA);
            ...
            for (const oracle of solanaOracles) {
                const [oraclePDA] = yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("Oracle"), oracleData.queue.toBuffer(), oracle.toBuffer()], this.program.programId);
    ...
    updateDelegationRewardPoolsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payer = program.provider.wallet.payer;
            const oracleData = yield this.loadData();
            const oracleStats = (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("OracleStats"), this.pubkey.toBuffer()], program.programId))[0];
            const lutSigner = (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("LutSigner"), this.pubkey.toBuffer()], program.programId))[0];
            const [delegationPool] = yield anchor_1.web3.PublicKey.findProgramAddress([
                buffer_1.Buffer.from("Delegation"),
                stateKey.toBuffer(),
                oracleStats.toBuffer(),
    ...
    statsKey() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("OracleStats"), this.pubkey.toBuffer()], this.program.programId))[0];
        });
    }
    lutKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [_, lutKey] = yield anchor_1.web3.AddressLookupTableProgram.createLookupTable({
                authority: lutSigner,
