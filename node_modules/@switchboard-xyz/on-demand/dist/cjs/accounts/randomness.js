...
function isNonSolana(queue) {
    return (queue.equals(utils_1.ON_DEMAND_MAINNET_QUEUE_PDA) ||
        queue.equals(utils_1.ON_DEMAND_DEVNET_QUEUE_PDA));
}
/**
...
class Randomness {
    ...
    static create(program, kp, queue, payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lutSigner = (yield anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("LutSigner"), kp.publicKey.toBuffer()], program.programId))[0];
            ...
            const [_, lut] = anchor_1.web3.AddressLookupTableProgram.createLookupTable({
                authority: lutSigner,
                payer: anchor_1.web3.PublicKey.default, // TODO: Should this be `payer`?
                recentSlot,
            });
    ...
    commitIx(queue, authority_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isNonSolana(queue)) {
                const isMainnet = queue.equals(utils_1.ON_DEMAND_MAINNET_QUEUE_PDA);
                ...
                [oracle] = anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("Oracle"), queue.toBuffer(), solanaOracle.toBuffer()], spl.ON_DEMAND_MAINNET_PID);
            }
            else {
    ...
    revealIx(payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isNonSolana(data.queue)) {
                yield new oracle_js_1.Oracle(this.program, data.oracle)
            ...
            const stats = anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("OracleRandomnessStats"), data.oracle.toBuffer()], this.program.programId)[0];
    ...
    commitAndReveal(callback, signers, queue, configs, debug) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authority = this.program.provider.wallet.payer;
            ...
            for (;;) {
                ...
                const tx = yield InstructionUtils_js_1.InstructionUtils.asV0TxWithComputeIxs({
                    connection,
                    ixs: [
                        anchor_1.web3.ComputeBudgetProgram.setComputeUnitPrice({
    ...
    static createAndCommitIxs(program, queue, payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            const payer = Randomness.getPayer(program, payer_);
            const accountKeypair = anchor_1.web3.Keypair.generate();
