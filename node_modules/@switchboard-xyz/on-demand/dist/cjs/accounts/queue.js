...
class Queue {
    static createIx(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queue = anchor_1.web3.Keypair.generate();
            ...
            const lutSigner = (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("LutSigner"), queue.publicKey.toBuffer()], program.programId))[0];
            ...
            if (stakePool.equals(anchor_1.web3.PublicKey.default)) {
            ...
            const ix = yield program.instruction.queueInit({
                ...
                accounts: {
                    ...
                    queueEscrow: yield spl.getAssociatedTokenAddress(constants_js_1.SOL_NATIVE_MINT, queue.publicKey),
    ...
    static createIxSVM(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [queue] = yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("Queue"), params.sourceQueueKey.toBuffer()], program.programId);
            const allowAuthorityOverrideAfter = (_a = params.allowAuthorityOverrideAfter) !== null && _a !== void 0 ? _a : 60 * 60;
            const requireAuthorityHeartbeatPermission = (_b = params.requireAuthorityHeartbeatPermission) !== null && _b !== void 0 ? _b : true;
            const requireUsagePermission = (_c = params.requireUsagePermission) !== null && _c !== void 0 ? _c : false;
            const maxQuoteVerificationAge = (_d = params.maxQuoteVerificationAge) !== null && _d !== void 0 ? _d : 60 * 60 * 24 * 7;
            ...
            const payer = program.provider.wallet.payer;
            // Prepare accounts for the transaction
            const lutSigner = (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("LutSigner"), queue.toBuffer()], program.programId))[0];
            const [delegationGroup] = yield anchor_1.web3.PublicKey.findProgramAddress([
                buffer_1.Buffer.from("Group"),
                stateKey.toBuffer(),
                state.stakePool.toBuffer(),
            ...
            const ix = program.instruction.queueInitSvm({
                ...
                accounts: {
                    queue: queue,
                    queueEscrow: yield spl.getAssociatedTokenAddress(constants_js_1.SOL_NATIVE_MINT, queue, true),
                    authority: payer.publicKey,
                    payer: payer.publicKey,
                    systemProgram: anchor_1.web3.SystemProgram.programId,
                    tokenProgram: constants_js_1.SPL_TOKEN_PROGRAM_ID,
    ...
    overrideSVM(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ix = this.program.instruction.queueOverrideSvm({
                ...
                maxQuoteVerificationAge: new anchor_1.BN(params.maxQuoteVerificationAge),
    ...
    initDelegationGroupIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [queueEscrowSigner] = yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("Signer"), this.pubkey.toBuffer()], pid);
            const ix = yield this.program.instruction.queueInitDelegationGroup({}, {
                accounts: {
                    queue: this.pubkey,
                    queueEscrow: yield spl.getAssociatedTokenAddress(constants_js_1.SOL_NATIVE_MINT, this.pubkey),
                    queueEscrowSigner,
                    payer: payer.publicKey,
                    systemProgram: anchor_1.web3.SystemProgram.programId,
                    tokenProgram: constants_js_1.SPL_TOKEN_PROGRAM_ID,
    ...
    fetchAllGateways() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oracleAccounts = yield anchor_1.utils.rpc.getMultipleAccounts(program.provider.connection, oracles);
            ...
            for (let i = 0; i < tests.length; i++) {
                try {
                    ...
                    const isGood = yield common_1.AsyncUtils.promiseWithTimeout(2000, tests[i]);
                    if (!isGood)
                        continue;
    ...
    setConfigsIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stateKey = state_js_1.State.keyFromSeed(this.program);
            const nodeTimeout = params.nodeTimeout ? new anchor_1.BN(params.nodeTimeout) : null;
    ...
    fetchFreshOracle() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oracles = yield this.fetchOracleKeys();
            const oracleAccounts = yield anchor_1.utils.rpc.getMultipleAccounts(this.program.provider.connection, oracles);
    ...
    static queuePDA(program, pubkey) {
        const [queuePDA] = anchor_1.web3.PublicKey.findProgramAddressSync([buffer_1.Buffer.from("Queue"), pubkey.toBuffer()], program.programId);
        return queuePDA;
    }
    lutSigner() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield anchor_1.web3.PublicKey.findProgramAddress([buffer_1.Buffer.from("LutSigner"), this.pubkey.toBuffer()], this.program.programId))[0];
        });
    }
    lutKey(lutSlot) {
        return __awaiter(this, void 0, void 0, function* () {
