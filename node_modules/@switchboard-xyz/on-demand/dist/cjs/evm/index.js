...
function simulateFeed(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = (yield gateway.fetchSignatures(Object.assign(Object.assign({}, params), { useTimestamp: true, recentHash: bs58_1.default.encode(buffer_1.Buffer.from((_b = params.recentHash) !== null && _b !== void 0 ? _b : "0".repeat(64), "hex")) }))).responses[0];
        return {
...
function getUpdate(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const gateway = (_a = params.gateway) !== null && _a !== void 0 ? _a : (yield queue.fetchGateway());
        const { responses, failures } = yield gateway.fetchSignatures(Object.assign(Object.assign({}, params), { useTimestamp: true, recentHash: bs58_1.default.encode(buffer_1.Buffer.from(params.recentHash, "hex")) }));
        const response = [];
        for (const result of responses) {
            ...
            const signatureBuffer = new Uint8Array(buffer_1.Buffer.from(result.signature, "base64"));
            // Assuming each component (r and s) is 32 bytes long
            const r = buffer_1.Buffer.from(signatureBuffer.slice(0, 32)).toString("hex");
            const s = buffer_1.Buffer.from(signatureBuffer.slice(32, 64)).toString("hex");
        ...
        response.sort((a, b) => { var _a, _b; return ((_a = a.response.timestamp) !== null && _a !== void 0 ? _a : 0) - ((_b = b.response.timestamp) !== null && _b !== void 0 ? _b : 0); });
        // Return the response
        return {
            responses: response,
            failures,
...
function getAttestation(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Decode from Base64 to a Buffer
        const signatureBuffer = new Uint8Array(buffer_1.Buffer.from(attestation.signature, "base64"));
        // Assuming each component (r and s) is 32 bytes long
        const r = buffer_1.Buffer.from(signatureBuffer.slice(0, 32)).toString("hex");
        const s = buffer_1.Buffer.from(signatureBuffer.slice(32, 64)).toString("hex");
