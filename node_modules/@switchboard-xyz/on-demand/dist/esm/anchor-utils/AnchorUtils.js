...
import { AnchorProvider, BorshEventCoder, Program, web3, } from "@coral-xyz/anchor";
...
export class AnchorUtils {
    static initWalletFromKeypair(keypair) {
        return __awaiter(this, void 0, void 0, function* () {
            const { default: NodeWallet } = yield import("@coral-xyz/anchor/dist/cjs/nodewallet");
    ...
    static loadProgramFromConnection(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wallet = yield this.initWalletFromKeypair(new web3.Keypair());
