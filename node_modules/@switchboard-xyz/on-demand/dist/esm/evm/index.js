...
import { createAttestationHexString, createUpdateHexString, createV0AttestationHexString, } from "./message.js";
 ...
 */
export function simulateFeed(params, queue) {
 ...
 */
export function getFeedUpdateData(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
export function getFeedUpdateWithContext(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        // Set the blockhash
 ...
 */
export function getUpdate(params, queue) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
