...
import { AsyncUtils } from "@switchboard-xyz/common";
...
export class Queue {
    static createIx(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lutSigner = (yield web3.PublicKey.findProgramAddress([Buffer.from("LutSigner"), queue.publicKey.toBuffer()], program.programId))[0];
            const [delegationGroup] = yield web3.PublicKey.findProgramAddress([
                Buffer.from("Group"),
                stateKey.toBuffer(),
            ...
            const ix = yield program.instruction.queueInit({
                ...
                accounts: {
                    ...
                    queueEscrow: yield spl.getAssociatedTokenAddress(SOL_NATIVE_MINT, queue.publicKey),
    ...
    static createIxSVM(program, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [queue] = yield web3.PublicKey.findProgramAddress([Buffer.from("Queue"), params.sourceQueueKey.toBuffer()], program.programId);
            const allowAuthorityOverrideAfter = (_a = params.allowAuthorityOverrideAfter) !== null && _a !== void 0 ? _a : 60 * 60;
            const requireAuthorityHeartbeatPermission = (_b = params.requireAuthorityHeartbeatPermission) !== null && _b !== void 0 ? _b : true;
            const requireUsagePermission = (_c = params.requireUsagePermission) !== null && _c !== void 0 ? _c : false;
            const maxQuoteVerificationAge = (_d = params.maxQuoteVerificationAge) !== null && _d !== void 0 ? _d : 60 * 60 * 24 * 7;
            ...
            const payer = program.provider.wallet.payer;
            // Prepare accounts for the transaction
            const lutSigner = (yield web3.PublicKey.findProgramAddress([Buffer.from("LutSigner"), queue.toBuffer()], program.programId))[0];
            const [delegationGroup] = yield web3.PublicKey.findProgramAddress([
                Buffer.from("Group"),
                stateKey.toBuffer(),
                state.stakePool.toBuffer(),
            ...
            const ix = program.instruction.queueInitSvm({
                ...
                accounts: {
                    queue: queue,
                    queueEscrow: yield spl.getAssociatedTokenAddress(SOL_NATIVE_MINT, queue, true),
                    authority: payer.publicKey,
                    payer: payer.publicKey,
                    systemProgram: web3.SystemProgram.programId,
                    tokenProgram: SPL_TOKEN_PROGRAM_ID,
    ...
    initDelegationGroupIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [queueEscrowSigner] = yield web3.PublicKey.findProgramAddress([Buffer.from("Signer"), this.pubkey.toBuffer()], pid);
            const ix = yield this.program.instruction.queueInitDelegationGroup({}, {
                accounts: {
                    queue: this.pubkey,
                    queueEscrow: yield spl.getAssociatedTokenAddress(SOL_NATIVE_MINT, this.pubkey),
                    queueEscrowSigner,
                    payer: payer.publicKey,
                    systemProgram: web3.SystemProgram.programId,
                    tokenProgram: SPL_TOKEN_PROGRAM_ID,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < tests.length; i++) {
                try {
                    ...
                    const isGood = yield AsyncUtils.promiseWithTimeout(2000, tests[i]);
                    if (!isGood)
                        continue;
    ...
    lutSigner() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield web3.PublicKey.findProgramAddress([Buffer.from("LutSigner"), this.pubkey.toBuffer()], this.program.programId))[0];
        });
    }
    lutKey(lutSlot) {
        return __awaiter(this, void 0, void 0, function* () {
            const lutSigner = yield this.lutSigner();
            const [_, lutKey] = yield web3.AddressLookupTableProgram.createLookupTable({
                authority: lutSigner,
