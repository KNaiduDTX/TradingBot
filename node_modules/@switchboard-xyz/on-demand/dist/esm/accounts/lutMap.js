...
export class LutMap {
    ...
    queueLutExtendIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lutSigner = (yield web3.PublicKey.findProgramAddress([Buffer.from("LutSigner"), params.queue.toBuffer()], this.program.programId))[0];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const oracle of oracles) {
                for (const feed of feeds) {
                    ...
                    const feedRewardEscrow = yield spl.getAssociatedTokenAddress(SOL_NATIVE_MINT, feed);
