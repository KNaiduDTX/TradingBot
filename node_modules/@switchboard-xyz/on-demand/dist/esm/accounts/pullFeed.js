...
export class PullFeed {
    ...
    initIx(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lutSigner = (yield web3.PublicKey.findProgramAddress([Buffer.from("LutSigner"), this.pubkey.toBuffer()], this.program.programId))[0];
    ...
    static fetchUpdateIxSvm(params, debug, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const jobs = yield crossbarClient
                ...
                .then((resp) => resp.jobs);
            const { responses, failures } = yield Queue.fetchSignatures(feed.program, {
                gateway: params.gateway,
                numSignatures: params.numSignatures,
                jobs: jobs,
    ...
    lookupTableKey(data) {
        const lutSigner = web3.PublicKey.findProgramAddressSync([Buffer.from("LutSigner"), this.pubkey.toBuffer()], this.program.programId)[0];
