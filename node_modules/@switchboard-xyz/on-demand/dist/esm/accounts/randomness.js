...
import { ON_DEMAND_DEVNET_QUEUE_PDA, ON_DEMAND_MAINNET_QUEUE_PDA, } from "../utils";
...
function isNonSolana(queue) {
    return (queue.equals(ON_DEMAND_MAINNET_QUEUE_PDA) ||
...
export class Randomness {
    ...
    static create(program, kp, queue, payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lutSigner = (yield web3.PublicKey.findProgramAddressSync([Buffer.from("LutSigner"), kp.publicKey.toBuffer()], program.programId))[0];
    ...
    revealIx(payer_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isNonSolana(data.queue)) {
                yield new Oracle(this.program, data.oracle)
