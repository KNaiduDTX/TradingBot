...
export class CrossbarClient {
    ...
    async fetch(feedHash) {
        try {
            ...
            console.log(`${this.crossbarUrl}/fetch/${feedHash}`);
    ...
    async fetchGateways(network = 'mainnet') {
        try {
            console.log(`${this.crossbarUrl}/gateways?network=${network}`);
    ...
    async fetchOracles(network) {
        try {
            console.log(`${this.crossbarUrl}/oracles?network=${network}`);
            return await axios
    ...
    async fetchSignatures(request, network) {
        try {
            return await axios
                .post(`${this.crossbarUrl}/oracles/fetch_signatures`, request, {
                params: { network },
            })
                .then(resp => resp.data);
        }
