...
export namespace oracle_job {
    ...
    interface IOracleJob {
        ...
        /** OracleJob minResponses */
        minResponses?: (number|null);

        /** OracleJob minSamples */
        minSamples?: (number|null);

        /** OracleJob maxVariance */
        maxVariance?: (number|Long|null);
    ...
    class OracleJob implements IOracleJob {
        ...
        /** OracleJob minResponses. */
        public minResponses: number;

        /** OracleJob minSamples. */
        public minSamples: number;

        /** OracleJob maxVariance. */
        public maxVariance: (number|Long);
    ...
    namespace OracleJob {
        ...
        interface ISolanaToken2022ExtensionTask {
            ...
            /** SolanaToken2022ExtensionTask mint */
            mint?: (string|null);
