...
describe('Health Cache', () => {
    it('test_health0', () => {
        ...
        const si1 = Serum3Info.fromOoModifyingTokenInfos(new Serum3Orders(PublicKey.default, 2, 4, 0, 0, 0), 1, ti2, 0, ti1, 2, {
    ...
    it('test_health1', (done) => {
        function testFixture(fixture) {
            ...
            const si1 = Serum3Info.fromOoModifyingTokenInfos(new Serum3Orders(PublicKey.default, 2, 4, 0, fixture.sa12[0], fixture.sa12[1]), 1, ti2, 0, ti1, 2, {
            ...
            const si2 = Serum3Info.fromOoModifyingTokenInfos(new Serum3Orders(PublicKey.default, 3, 5, 0, fixture.sa13[0], fixture.sa13[1]), 2, ti3, 0, ti1, 3, {
    ...
    it('test_max_swap', (done) => {
        ...
        expect(hc
            .getMaxSwapSourceForHealthRatio(b0, b1, I80F48.fromNumber(2 / 3), I80F48.fromNumber(50))
            .toNumber()).lessThan(0.0000001);
        function findMaxSwapActual(hc, source, target, minValue, priceFactor, maxSwapFn) {
            const clonedHc = deepClone(hc);
            ...
            const sourceAmount = clonedHc.getMaxSwapSourceForHealthFn(banks[source], banks[target], swapPrice, I80F48.fromNumber(minValue), maxSwapFn);
            function valueForAmount(amount) {
                // adjust token balance
                const clonedHcClone = deepClone(clonedHc);
        ...
        for (const fn of [maxSwapFn, maxSwapFnRatio]) {
            ...
            // TODO test 5
            {
                ...
                clonedHc.serum3Infos = [
                    new Serum3Info(I80F48.fromNumber(30 / 3), I80F48.fromNumber(30 / 2), ZERO_I80F48(), ZERO_I80F48(), 1, 0, 0),
                ];
                // adjust by usdc
                clonedHc.tokenInfos[0].balanceSpot.iadd(I80F48.fromNumber(-20).div(clonedHc.tokenInfos[0].prices.oracle));
            ...
            }
            {
                ...
                expect(findMaxSwapActual(clonedHc, 0, 1, 1, 1, maxSwapFn)[0] > 0);
                for (const priceFactor of [0.9, 1.1]) {
                    for (const target of range(1, 100, 1)) {
                        checkMaxSwapResult(clonedHc, 0, 1, target, priceFactor, fn);
                    }
    ...
    it('test_max_perp', (done) => {
        ...
        expect(hc
            .getMaxPerpForHealthRatio(p0, I80F48.fromNumber(2), PerpOrderSide.bid, I80F48.fromNumber(50))
            .toNumber()).equals(0);
        function findMaxTrade(hc, side, ratio, priceFactor) {
            ...
            const baseLots0 = hc
                .getMaxPerpForHealthRatio(p0, tradePrice, side, I80F48.fromNumber(ratio))
                .toNumber();
            ...
            let baseNative = I80F48.fromNumber(baseLots1).mul(I80F48.fromNumber(baseLotSize));
            let hcClone = deepClone(hc);
    ...
    it('Modify copy of health object leaving original object unchanged', (done) => {
        ...
        expect(hc.tokenInfos[1].balanceSpot.eq(clonedHc.tokenInfos[1].balanceSpot))
            .to.be.false;
        expect(hc.tokenInfos[1].prices.oracle.eq(clonedHc.tokenInfos[1].prices.oracle)).to.be.false;
        //one is unchanged
        ...
        expect(hc['addProp'] === undefined && clonedHc['addProp'] === '123').to.be
            .true;
        clonedHc.adjustPerpInfo(0, new I80F48(new BN(100000)), PerpOrderSide.ask, new BN(100000));
        //original object is unaffected by running method from inside the clonedObj
        expect(clonedHc.perpInfos[0].baseLots.eq(hc.perpInfos[0].baseLots) &&
            clonedHc.perpInfos[0].quote.eq(hc.perpInfos[0].quote)).to.be.false;
        expect(clonedHc.healthRatio(HealthType.init).eq(hc.healthRatio(HealthType.init))).to.be.false;
        done();
    });
