...
exports.TrueIxGateParams = exports.NullPerpEditParams = exports.NullTokenEditParams = exports.DefaultTokenRegisterParams = void 0;
exports.buildIxGate = buildIxGate;
const anchor_1 = require("@coral-xyz/anchor");
exports.DefaultTokenRegisterParams = {
    oracleConfig: {
        confFilter: 0.3,
    ...
    depositLimit: new anchor_1.BN(0),
    zeroUtilRate: 0.0,
...
function buildIxGate(p) {
    const ixGate = new anchor_1.BN(0);
    function toggleIx(ixGate, p, propName, index) {
        if (p[propName] === undefined) {
            throw new Error(`Unknown property ${propName}`);
        }
        ixGate.ior(p[propName] ? new anchor_1.BN(0) : new anchor_1.BN(1).ushln(index));
    }
