 ...
 * @returns
 */
export declare function getLargestPerpPositions(client: MangoClient, group: Group, accounts?: MangoAccount[], perpMarket?: PerpMarket): Promise<{
 ...
 * @returns
 */
export declare function getClosestToLiquidationPerpPositions(client: MangoClient, group: Group, accounts?: MangoAccount[], filterByNotionalValueUi?: number): Promise<{
    mangoAccount: PublicKey;
    perpPosition: PerpPosition;
    pct: I80F48;
}[]>;
