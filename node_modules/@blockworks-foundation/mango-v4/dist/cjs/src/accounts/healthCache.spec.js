...
function mockBankAndOracle(tokenIndex, maintWeight, initWeight, price, stablePrice, deposits = 0, borrows = 0, borrowWeightScaleStartQuote = Number.MAX_SAFE_INTEGER, depositWeightScaleStartQuote = Number.MAX_SAFE_INTEGER) {
    return {
        tokenIndex,
        maintAssetWeight: I80F48_1.I80F48.fromNumber(1 - maintWeight),
        initAssetWeight: I80F48_1.I80F48.fromNumber(1 - initWeight),
        maintLiabWeight: I80F48_1.I80F48.fromNumber(1 + maintWeight),
        initLiabWeight: I80F48_1.I80F48.fromNumber(1 + initWeight),
        price: I80F48_1.I80F48.fromNumber(price),
        ...
        maintWeights: () => [
            I80F48_1.I80F48.fromNumber(1 - maintWeight),
            I80F48_1.I80F48.fromNumber(1 + maintWeight),
        ],
...
function mockPerpMarket(perpMarketIndex, settleTokenIndex, maintBaseWeight, initBaseWeight, baseLotSize, price) {
    return {
        ...
        initBaseAssetWeight: I80F48_1.I80F48.fromNumber(1 - initBaseWeight),
        maintBaseLiabWeight: I80F48_1.I80F48.fromNumber(1 + maintBaseWeight),
        initBaseLiabWeight: I80F48_1.I80F48.fromNumber(1 + initBaseWeight),
        maintOverallAssetWeight: I80F48_1.I80F48.fromNumber(1 - 0.02),
        initOverallAssetWeight: I80F48_1.I80F48.fromNumber(1 - 0.05),
        price: I80F48_1.I80F48.fromNumber(price),
        stablePriceModel: { stablePrice: price },
        quoteLotSize: new anchor_1.BN(100),
        baseLotSize: new anchor_1.BN(baseLotSize),
        longFunding: (0, I80F48_1.ZERO_I80F48)(),
        shortFunding: (0, I80F48_1.ZERO_I80F48)(),
    };
}
describe('Health Cache', () => {
    it('test_health0', () => {
        ...
        const ti1 = healthCache_1.TokenInfo.fromBank(sourceBank, I80F48_1.I80F48.fromNumber(100));
        const ti2 = healthCache_1.TokenInfo.fromBank(targetBank, I80F48_1.I80F48.fromNumber(-10));
        const si1 = healthCache_1.Serum3Info.fromOoModifyingTokenInfos(new mangoAccount_1.Serum3Orders(web3_js_1.PublicKey.default, 2, 4, 0, 0, 0), 1, ti2, 0, ti1, 2, {
            quoteTokenTotal: new anchor_1.BN(21),
            baseTokenTotal: new anchor_1.BN(18),
            quoteTokenFree: new anchor_1.BN(1),
            baseTokenFree: new anchor_1.BN(3),
            referrerRebatesAccrued: new anchor_1.BN(2),
        });
    ...
    it('test_health1', (done) => {
        function testFixture(fixture) {
            ...
            const ti2 = healthCache_1.TokenInfo.fromBank(bank2, I80F48_1.I80F48.fromNumber(fixture.token2));
            const ti3 = healthCache_1.TokenInfo.fromBank(bank3, I80F48_1.I80F48.fromNumber(fixture.token3));
            const si1 = healthCache_1.Serum3Info.fromOoModifyingTokenInfos(new mangoAccount_1.Serum3Orders(web3_js_1.PublicKey.default, 2, 4, 0, fixture.sa12[0], fixture.sa12[1]), 1, ti2, 0, ti1, 2, {
                quoteTokenTotal: new anchor_1.BN(fixture.oo12[0]),
                baseTokenTotal: new anchor_1.BN(fixture.oo12[1]),
                quoteTokenFree: new anchor_1.BN(0),
                baseTokenFree: new anchor_1.BN(0),
                referrerRebatesAccrued: new anchor_1.BN(0),
            });
            const si2 = healthCache_1.Serum3Info.fromOoModifyingTokenInfos(new mangoAccount_1.Serum3Orders(web3_js_1.PublicKey.default, 3, 5, 0, fixture.sa13[0], fixture.sa13[1]), 2, ti3, 0, ti1, 3, {
                quoteTokenTotal: new anchor_1.BN(fixture.oo13[0]),
                baseTokenTotal: new anchor_1.BN(fixture.oo13[1]),
                quoteTokenFree: new anchor_1.BN(0),
                baseTokenFree: new anchor_1.BN(0),
                referrerRebatesAccrued: new anchor_1.BN(0),
            });
            ...
            const pi1 = healthCache_1.PerpInfo.fromPerpPosition(pM, pp);
            const hc = new healthCache_1.HealthCache([ti1, ti2, ti3], [si1, si2], [pi1]);
            const health = hc.health(mangoAccount_1.HealthType.init).toNumber();
            console.log(` - case "${fixture.name}" health ${health
                .toFixed(3)
                .padStart(10)}, expected ${fixture.expectedHealth}`);
            (0, chai_1.expect)(Math.abs(health - fixture.expectedHealth)).lessThan(0.0000001);
        }
        const basePrice = 5;
    ...
    it('test_max_swap', (done) => {
        ...
        const hc = new healthCache_1.HealthCache([
            ...
            healthCache_1.TokenInfo.fromBank(b2, I80F48_1.I80F48.fromNumber(0)),
        ], [], []);
        (0, chai_1.expect)(hc
            .getMaxSwapSourceForHealthRatio(b0, b1, I80F48_1.I80F48.fromNumber(2 / 3), I80F48_1.I80F48.fromNumber(50))
            .toNumber()).lessThan(0.0000001);
        function findMaxSwapActual(hc, source, target, minValue, priceFactor, maxSwapFn) {
            const clonedHc = (0, utils_1.deepClone)(hc);
            const sourcePrice = clonedHc.tokenInfos[source].prices;
            const targetPrice = clonedHc.tokenInfos[target].prices;
            const swapPrice = I80F48_1.I80F48.fromNumber(priceFactor)
                .mul(sourcePrice.oracle)
                .div(targetPrice.oracle);
            const sourceAmount = clonedHc.getMaxSwapSourceForHealthFn(banks[source], banks[target], swapPrice, I80F48_1.I80F48.fromNumber(minValue), maxSwapFn);
            function valueForAmount(amount) {
                // adjust token balance
                const clonedHcClone = (0, utils_1.deepClone)(clonedHc);
            ...
            return [
                ...
                valueForAmount(sourceAmount.sub((0, I80F48_1.ONE_I80F48)())).toNumber(),
                valueForAmount(sourceAmount.add((0, I80F48_1.ONE_I80F48)())).toNumber(),
            ];
        }
        function checkMaxSwapResult(hc, source, target, minValue, priceFactor, maxSwapFn) {
            const [sourceAmount, actualValue, minusValue, plusValue] = findMaxSwapActual(hc, source, target, minValue, priceFactor, maxSwapFn);
            console.log(` -- checking ${source} to ${target} for priceFactor: ${priceFactor}, target: ${minValue} actual: ${minusValue}/${actualValue}/${plusValue}, amount: ${sourceAmount}`);
            if (actualValue < minValue) {
                // check that swapping more would decrease the ratio!
                (0, chai_1.expect)(plusValue < actualValue);
            }
            else {
                (0, chai_1.expect)(actualValue >= minValue);
                // either we're within tolerance of the target, or swapping 1 more would
                // bring us below the target
                (0, chai_1.expect)(actualValue < minValue + 1 || plusValue < minValue);
            }
        }
        function maxSwapFnRatio(hc) {
            return hc.healthRatio(mangoAccount_1.HealthType.init);
        }
        function maxSwapFn(hc) {
        ...
        for (const fn of [maxSwapFn, maxSwapFnRatio]) {
            {
                ...
                for (const priceFactor of [0.1, 0.9, 1.1]) {
                    for (const target of (0, range_1.default)(1, 100, 1)) {
                        checkMaxSwapResult(clonedHc, 0, 1, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 1, 0, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 0, 2, target, priceFactor, fn);
                    }
                }
                // At this unlikely price it's healthy to swap infinitely
                (0, chai_1.expect)(function () {
                    findMaxSwapActual(clonedHc, 0, 1, 50.0, 1.5, fn);
            ...
            }
            {
                ...
                for (const priceFactor of [0.1, 0.9, 1.1]) {
                    for (const target of (0, range_1.default)(1, 100, 1)) {
                        ...
                        checkMaxSwapResult(clonedHc, 1, 0, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 0, 2, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 2, 0, target, priceFactor, fn);
                    }
                }
            }
            {
                ...
                checkMaxSwapResult(clonedHc, 1, 0, 100, 1, maxSwapFn);
            }
            {
                console.log(' - test 3');
                const clonedHc = (0, utils_1.deepClone)(hc);
                ...
                const initRatio = clonedHc.healthRatio(mangoAccount_1.HealthType.init).toNumber();
                const [amount, actualRatio] = findMaxSwapActual(clonedHc, 1, 0, 100, 1, maxSwapFn);
                (0, chai_1.expect)(actualRatio / 2.0 > initRatio);
                (0, chai_1.expect)(amount - 100 / 3).lessThan(1);
            }
            {
                console.log(' - test 4');
                const clonedHc = (0, utils_1.deepClone)(hc);
                ...
                (0, chai_1.expect)(initRatio.toNumber()).greaterThan(3);
                (0, chai_1.expect)(initRatio.toNumber()).lessThan(4);
                checkMaxSwapResult(clonedHc, 0, 1, 1, 1, maxSwapFn);
                checkMaxSwapResult(clonedHc, 0, 1, 3, 1, maxSwapFn);
                checkMaxSwapResult(clonedHc, 0, 1, 4, 1, maxSwapFn);
            }
            // TODO test 5
            {
                console.log(' - test 6');
                ...
                clonedHc.serum3Infos = [
                    new healthCache_1.Serum3Info(I80F48_1.I80F48.fromNumber(30 / 3), I80F48_1.I80F48.fromNumber(30 / 2), (0, I80F48_1.ZERO_I80F48)(), (0, I80F48_1.ZERO_I80F48)(), 1, 0, 0),
                ];
                // adjust by usdc
                clonedHc.tokenInfos[0].balanceSpot.iadd(I80F48_1.I80F48.fromNumber(-20).div(clonedHc.tokenInfos[0].prices.oracle));
                ...
                for (const priceFactor of [0.9, 1.1]) {
                    for (const target of (0, range_1.default)(1, 100, 1)) {
                        ...
                        checkMaxSwapResult(clonedHc, 1, 0, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 0, 2, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 1, 2, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 2, 0, target, priceFactor, fn);
                        checkMaxSwapResult(clonedHc, 2, 1, target, priceFactor, fn);
                    }
                }
            }
            {
            ...
            }
            {
                ...
                (0, chai_1.expect)(findMaxSwapActual(clonedHc, 0, 1, 1, 1, maxSwapFn)[0] > 0);
                for (const priceFactor of [0.9, 1.1]) {
                    for (const target of (0, range_1.default)(1, 100, 1)) {
                        checkMaxSwapResult(clonedHc, 0, 1, target, priceFactor, fn);
                    }
    ...
    it('test_max_perp', (done) => {
        ...
        (0, chai_1.expect)(hc
            .getMaxPerpForHealthRatio(p0, I80F48_1.I80F48.fromNumber(2), perp_1.PerpOrderSide.bid, I80F48_1.I80F48.fromNumber(50))
            .toNumber()).equals(0);
        function findMaxTrade(hc, side, ratio, priceFactor) {
            ...
            const baseLots0 = hc
                .getMaxPerpForHealthRatio(p0, tradePrice, side, I80F48_1.I80F48.fromNumber(ratio))
                .toNumber();
            ...
            let baseNative = I80F48_1.I80F48.fromNumber(baseLots1).mul(I80F48_1.I80F48.fromNumber(baseLotSize));
            let hcClone = (0, utils_1.deepClone)(hc);
            hcClone.perpInfos[0].baseLots.iadd(new anchor_1.BN(baseLots1));
            hcClone.perpInfos[0].quote.isub(baseNative.mul(tradePrice));
            const actualRatio = hcClone.healthRatio(mangoAccount_1.HealthType.init);
            // the ratio for trading just one base lot extra
            const baseLots2 = direction * (baseLots0 + 1);
            baseNative = I80F48_1.I80F48.fromNumber(baseLots2 * baseLotSize);
            hcClone = (0, utils_1.deepClone)(hc);
            hcClone.perpInfos[0].baseLots.iadd(new anchor_1.BN(baseLots2));
            hcClone.perpInfos[0].quote.isub(baseNative.mul(tradePrice));
            const plusRatio = hcClone.healthRatio(mangoAccount_1.HealthType.init);
            return [baseLots0, actualRatio.toNumber(), plusRatio.toNumber()];
        }
        function checkMaxTrade(hc, side, ratio, priceFactor) {
            const [baseLots, actualRatio, plusRatio] = findMaxTrade(hc, side, ratio, priceFactor);
        ...
        checkMaxTrade(hc, perp_1.PerpOrderSide.bid, 50, 2);
        checkMaxTrade(hc, perp_1.PerpOrderSide.ask, 50, 0.1);
        // and extremely good prices
        (0, chai_1.expect)(function () {
            findMaxTrade(hc, perp_1.PerpOrderSide.bid, 50, 0.1);
        }).to.throw();
        (0, chai_1.expect)(function () {
            findMaxTrade(hc, perp_1.PerpOrderSide.ask, 50, 1.5);
        }).to.throw();
        done();
    });
    it('Modify copy of health object leaving original object unchanged', (done) => {
        ...
        clonedHc.tokenInfos[0].balanceSpot.iadd(I80F48_1.I80F48.fromNumber(100).div(clonedHc.tokenInfos[0].prices.oracle));
        clonedHc.tokenInfos[1].balanceSpot.iadd(I80F48_1.I80F48.fromNumber(-2).div(clonedHc.tokenInfos[1].prices.oracle));
        clonedHc.tokenInfos[1].prices.oracle.iadd(new I80F48_1.I80F48(new anchor_1.BN(333333)));
        (0, chai_1.expect)(hc.tokenInfos[0].balanceSpot.eq(clonedHc.tokenInfos[0].balanceSpot))
            .to.be.false;
        (0, chai_1.expect)(hc.tokenInfos[1].balanceSpot.eq(clonedHc.tokenInfos[1].balanceSpot))
            .to.be.false;
        (0, chai_1.expect)(hc.tokenInfos[1].prices.oracle.eq(clonedHc.tokenInfos[1].prices.oracle)).to.be.false;
        //one is unchanged
        (0, chai_1.expect)(hc.tokenInfos[2].balanceSpot.eq(clonedHc.tokenInfos[2].balanceSpot))
            .to.be.true;
        //do something stupid
        clonedHc['addProp'] = '123';
        (0, chai_1.expect)(hc['addProp'] === undefined && clonedHc['addProp'] === '123').to.be
            .true;
        clonedHc.adjustPerpInfo(0, new I80F48_1.I80F48(new anchor_1.BN(100000)), perp_1.PerpOrderSide.ask, new anchor_1.BN(100000));
        //original object is unaffected by running method from inside the clonedObj
        (0, chai_1.expect)(clonedHc.perpInfos[0].baseLots.eq(hc.perpInfos[0].baseLots) &&
            clonedHc.perpInfos[0].quote.eq(hc.perpInfos[0].quote)).to.be.false;
        (0, chai_1.expect)(clonedHc.healthRatio(mangoAccount_1.HealthType.init).eq(hc.healthRatio(mangoAccount_1.HealthType.init))).to.be.false;
        done();
    });
