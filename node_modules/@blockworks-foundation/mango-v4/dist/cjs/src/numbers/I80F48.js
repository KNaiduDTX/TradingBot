...
exports.I80F48 = exports.I80F48Dto = void 0;
exports.ONE_I80F48 = ONE_I80F48;
exports.MINUS_ONE_I80F48 = MINUS_ONE_I80F48;
exports.ZERO_I80F48 = ZERO_I80F48;
exports.HUNDRED_I80F48 = HUNDRED_I80F48;
exports.MAX_I80F48 = MAX_I80F48;
...
class I80F48 {
    ...
    static MAX_SIZE = 128;
    static FRACTIONS = 48;
    static MULTIPLIER_BIG = new big_js_1.default(2).pow(I80F48.FRACTIONS);
    static MULTIPLIER_BN = new bn_js_1.default(2).pow(new bn_js_1.default(I80F48.FRACTIONS));
    static MULTIPLIER_NUMBER = Math.pow(2, I80F48.FRACTIONS);
    static MAX_BN = new bn_js_1.default(2)
        .pow(new bn_js_1.default(I80F48.MAX_SIZE))
        .div(new bn_js_1.default(2))
        .sub(new bn_js_1.default(1));
    static MIN_BN = new bn_js_1.default(2)
        .pow(new bn_js_1.default(I80F48.MAX_SIZE))
        .div(new bn_js_1.default(2))
        .neg();
    ...
    static fromNumber(x) {
        ...
        const v = new bn_js_1.default(int_part.toFixed(0)).iushln(48);
